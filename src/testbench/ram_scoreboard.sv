      ...
      begin
       ...
       // fork 
          ...
          //getting the reference model transaction from mailbox 
           ...
           $display("%0t SCOREBOARD REFdata_out=%0d, ADDRESS=%d",$time,ref_mem[ref2sb_trans.address],ref2sb_trans.address);
          end
          begin
          //getting the monitor transaction from mailbox 
           mbx_ms.get(mon2sb_trans);
           mon_mem[mon2sb_trans.address]=mon2sb_trans.data_out;
           $display("%0t SCOREBOARD MONdata_out=%0d,  ADDRESS=%d",$time,mon_mem[mon2sb_trans.address],mon2sb_trans.address);
          end
          compare_report();
       // join
      end
